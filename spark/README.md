...
```
$ mvn -Pspark-4 -Dspark.version=4.1.1.3.3.6.501-SNAPSHOT -Dhadoop-three.version=3.3.6.3.3.6.501-SNAPSHOT -Dhbase.version=2.6.2.3.3.6.501-SNAPSHOT clean install
```
